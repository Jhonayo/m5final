    ...
    <form action="modificarusuario" method="POST">
        ...
        <div class="row mb-3">
         ...
         <div class="row mb-3">
            ...
            <div class="col-sm-8 col-xl-8">
                <input type="date" class="form-control" name="fechaNacimiento" id="inputFechaNacimiento"
        ...
        <div class="row mb-3">
            ...
            <div class="col-sm-8 col-xl-8">
                <input type="password" class="form-control" id="inputPasswordConfirmacion" required>
            </div>
        </div>

        <div class="mt-5">
        <button type="submit" class="btn btn-primary me-2" onclick="return confirm('¿Desea guardar los cambios?')">
            Actualizar
        </button>
